...
class TemporalTransformer3DModel(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None):
        print(f"TT3D hidden_states shape: {hidden_states.shape} $$$$")
        ...
        #     batch, height * weight, inner_dim
        # )
        print(f"TT3D hidden_states shape initial permute/reshape: {hidden_states.shape} $$$$")
        hidden_states = self.proj_in(hidden_states)
        print(f"TT3D hidden_states shape after proj_in: {hidden_states.shape} $$$$")
        ...
        print(f"TT3D hidden_states shape after proj_out: {hidden_states.shape} $$$$")
        hidden_states = (
        ...
        #     .contiguous()
        # )
        print(f"TT3D hidden_states shape final permute/reshape: {hidden_states.shape} $$$$")
...
class VersatileAttention(CrossAttention):
    ...
    def forward(
        ...
        print(f"$$$$ in mm Versatile Attention!")
        ...
        if encoder_hidden_states is not None: print(f"$$$$ encoder_hidden states after rearranged: {encoder_hidden_states.shape}")
